...
public class Sprite {
    ...
    // Pass
    public static Sprite pass_left1 = new Sprite(16, 12, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite pass_left2 = new Sprite(16, 12, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite pass_left3 = new Sprite(16, 12, 7, SpriteSheet.tiles, 16, 16);

    public static Sprite pass_right1 = new Sprite(16, 13, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite pass_right2 = new Sprite(16, 13, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite pass_right3 = new Sprite(16, 13, 7, SpriteSheet.tiles, 16, 16);
    public static Sprite pass_dead = new Sprite(16, 12, 8, SpriteSheet.tiles, 16, 16);

    // Doria
    public static Sprite doria_left1 = new Sprite(16, 14, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite doria_left2 = new Sprite(16, 14, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite doria_left3 = new Sprite(16, 14, 7, SpriteSheet.tiles, 16, 16);

    public static Sprite doria_right1 = new Sprite(16, 15, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite doria_right2 = new Sprite(16, 15, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite doria_right3 = new Sprite(16, 15, 7, SpriteSheet.tiles, 16, 16);

    public static Sprite doria_dead = new Sprite(16, 14, 8, SpriteSheet.tiles, 16, 16);
    //Pontan
    public static Sprite pontan_left1 = new Sprite(16, 4, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite pontan_left2 = new Sprite(16, 4, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite pontan_left3 = new Sprite(16, 4, 7, SpriteSheet.tiles, 16, 16);

    public static Sprite pontan_right1 = new Sprite(16, 5, 5, SpriteSheet.tiles, 16, 16);
    public static Sprite pontan_right2 = new Sprite(16, 5, 6, SpriteSheet.tiles, 16, 16);
    public static Sprite pontan_right3 = new Sprite(16, 5, 7, SpriteSheet.tiles, 16, 16);

    public static Sprite pontan_dead = new Sprite(16, 4, 8, SpriteSheet.tiles, 16, 16);
