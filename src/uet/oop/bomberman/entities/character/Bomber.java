...
public class Bomber extends Character {
    ...
    static boolean UsedSpeedItem = false;
...
//        System.out.println(tileX + " " + tileY);
    ...
    private void timeLimitUsedItem() {
        ...
        // SpeedItem
        if (UsedSpeedItem == true && _timeUsedSpeedItem <= 0) {
            UsedSpeedItem = false;
    ...
    public void addItem(Item p) {
        ...
        if (p instanceof BombItem) {
            _timeUsedBombItem = 900; // ~ 120 seconds
            _UsedBombItem = true;
        } else if (p instanceof SpeedItem) {
            _timeUsedSpeedItem = 900;
            UsedSpeedItem = true;
        } else if (p instanceof FlameItem) {
            _timeUsedFlameItem = 900;
            _UsedFlameItem = true;
        }
        Sound s = new Sound();
        s.setFile("res/sound/getItem.wav",3);
        s.play(3);
        p.setValues();
    }
