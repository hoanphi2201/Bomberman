...
public class Board implements IRender {
    ...
    public Board(Game game, Keyboard input, Screen screen) {
        ...
        _screen = screen;
        s = new Sound();
        s.setFile("res/sound/stageTheme.wav", 1);
        s2 = new Sound();
        s2.setFile("res/sound/titleScreen.wav", 7);
        s2.play(7);
        loadLevel(5);
    }
    ...
    public void nextLevel() {
        Game.bombRate = Game.bombBeforeNextLevel;
        Game.bombRadius = Game.getBombRadius();
        Game.bomberSpeed = Game.getBomberSpeed();
        loadLevel(_levelLoader.getLevel() + 1);
    }

    public void loadLevel(int level) {
        _time = Game.TIME;
        _screenToShow = level == 1 ? 4 : 2;
        if (loadAgain) {
            _screenToShow = 2;
            loadAgain = false;
        }
    ...
    public void endGame() {
        s.close(1);
        Sound die = new Sound();
        die.setFile("res/sound/die.wav", 6);
        die.play(6);
        try {
            Thread.sleep(2000);
    ...
    public void detectNewgame() {
        if (_input.newgame) {
            s2.close(7);
            Sound start = new Sound();
            start.setFile("res/sound/stageStart.wav", 2);
            start.play(2);
            try {
                Thread.sleep(3000);
            } catch (InterruptedException ex) {
    ...
    public void drawScreen(Graphics g) {
        switch (_screenToShow) {
            ...
            case 3:
                ...
                break;
            case 4:
                _screen.drawStartGame(g);
                break;
            case 5:
                _screen.drawExitGame(g, _points);
                break;
            case 6:
    ...
    public void restartLevel() {
        loadAgain = true;
        Game.bombBeforeNextLevel = Game.BOMBRATE;
        Game.bombRadius = 1;
        Game.bombRate = 1;
